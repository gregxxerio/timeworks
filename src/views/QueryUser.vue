<template>
  <div class="container-home" style="background: transparent;">
          <h1 class="title-home">Revisión de mis registros</h1>
          <div class="card-body card-shadow mt-2" >
            <!-- <div class=" d-flex align-items-center"> -->
              <form class="form-inline" style="padding: 2% 0;background: #f4f7f9;border-radius: 8px;border: 1px solid #cbe0ee;justify-content: center;">
                <div class="form-group mb-2">
                  <b style="color: #969696">Rango de fechas: </b>
                  <a-range-picker @change="dateRange" class="form-control mx-sm-3" />
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2" style="width: 94%;justify-content: end;">
                  <a href="#" @click="projectChange" class="btn-apply my-1">
                    Aplicar
...
<!--
            ...
            <div class="row" v-else>
              ...
              <div class="col-12 p-1" v-show="showBarHorizontalChart" style=" background-color: #F1EFEF">
                <div class="row-grid" style="justify-items: center;">
                  <div class="col-3-g">
            ...
            <div class="row mt-3">
              ...
              <div v-show="showCharts" class="col-md-6" v-for="(option, index) in charts" :key="index">
                ...
                <div class="row text-center justify-content-center" :style="'max-width:'+screenWidth+';'">
