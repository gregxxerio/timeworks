        ...
        <template v-if="origin == 'user'">
          <div class="grid-inputs-one">
            ...
            <div class="grid-buttons">
              <button type="button" class="btn btn-outline-info btn-left btn-w btn-pd fw" @click="year = 2022;getHistory();" :class="year == 2022 ? 'active' : ''">2022</button>
              <button type="button" class="btn btn-outline-info btn-center btn-w btn-pd fw" @click="year = 2023;getHistory();" :class="year == 2023 ? 'active' : ''">2023</button>
              <button type="button" class="btn btn-outline-info btn-right btn-w btn-pd fw" @click="year = 2024;getHistory();" :class="year == 2024 ? 'active' : ''">2024</button>
            </div>
          </div>
        </template>
