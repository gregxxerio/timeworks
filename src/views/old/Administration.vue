<template>
  <div class="container-home-dos " >
    ...
    <div class="card p-lr" >
      ...
      <div class="p-4" v-show="type === '' || $route.fullPath != '/administration?detail'">
      ...
      <template>
        <VueWindowDimensions>
          <template slot-scope="{ dimensions }">
            <div v-if="dimensions" :style="'width :' + (dimensions.width -  (dimensions.width < 560 ? 50 : dimensions.width < 774 ? 75 : 200)) + 'px;'" class="card-body card-shadow mt-4 data-query" v-show="type != '' && type != types.reportsgeneration && $route.fullPath === '/administration?detail'">
